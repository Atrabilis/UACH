...
#Capa de entrada
neurona1 = Neurona(X3, pesos1, 0, signo)  #Crea una neurona con entradas X1, pesos1 y función de activación sigmoidal
neurona2 = Neurona(X3, pesos2, 0, signo)  #Crea una neurona con entradas X1, pesos2 y función de activación sigmoidal
neurona3 = Neurona(X3, pesos3, 0, signo)  #Crea una neurona con entradas X1, pesos3 y función de activación sigmoidal
...
neurona4 = Neurona(np.reshape([neurona1.salida(),
            ...
            neurona3.salida()], (-1, 1)),
                   ...
                   signo)  #Crea una neurona con entradas formadas por las salidas de las neuronas 1, 2 y 3,
                                      #pesos4 y función de activación sigmoidal
...
neurona5 = Neurona(np.reshape([neurona1.salida(),
            ...
            neurona3.salida()], (-1, 1)),
                   ...
                   0,
                   signo)  #Crea una neurona con entradas formadas por las salidas de las neuronas 1, 2 y 3,
                                      #pesos5 y función de activación sigmoidal
