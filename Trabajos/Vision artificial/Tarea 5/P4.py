...
#Capa de entrada
neurona1 = Neurona(X4, pesos1, 0, escalon_unitario)  #Crea una neurona con entradas X1, pesos1 y función de activación escalon unitario
neurona2 = Neurona(X4, pesos2, 0, escalon_unitario)  #Crea una neurona con entradas X1, pesos2 y función de activación escalon unitario
neurona3 = Neurona(X4, pesos3, 0, escalon_unitario)  #Crea una neurona con entradas X1, pesos3 y función de activación escalon unitario
...
neurona6 = Neurona(np.reshape([neurona4.salida(),
            neurona5.salida()], (-1, 1)),
                   pesos6,
                   0,
                   sigmoidal)  #Crea una neurona con entradas formadas por las salidas de las neuronas 4 y 5,
                                      #pesos6 y función de activación sigmoidal
