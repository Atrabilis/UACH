...
# Entrenar el modelo
history = model.fit(train_images, train_labels, epochs=1000, batch_size=32, validation_data=(val_images, val_labels))
...
# Mostrar el historial de precisión de entrenamiento y prueba
